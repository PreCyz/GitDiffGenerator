...
For Git: `git log --all --remotes=origin --patch --author=userName --since yyyy-MM-dd --until yyyy-MM-dd`<br />
...
For Git: `git log --all --remotes=origin --oneline --author=userName --since yyyy-MM-dd --until yyyy-MM-dd`<br />
